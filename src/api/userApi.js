...
export const updateStripe = (data) => {
  return axios
    .post(config.api_url + "/api/v1/user/updatestripe", data)
    .then((response) => {
      return response.data;
    })
    .catch((err) => {
...
export const saveSubUser = async (data) => {
  ...
  return axios
    .post(config.api_url + "/api/v1/subuser/add", data, {
...
export const getAllSubuser = async (user_id) => {
  const token = await AsyncStorage.getItem("4brntoken");
  return axios
    .get(config.api_url + "/api/v1/subuser/get/all/" + user_id, {
      headers: { "x-access-token": token },
    })
    .then((response) => {
      return response.data;
...
export const getSubUser = (id) => {
  return axios
    .get(config.api_url + "/api/v1/subuser/get/all/" + id, { headers })
    .then((response) => {
      return response.data;
    })
    .catch((err) => {
...
export const setNotification = async (data, id) => {
  const token = await AsyncStorage.getItem("4brntoken");
  return axios
    .put(config.api_url + "/api/v1/user/set/notification/" + id, data, {
      headers: { "x-access-token": token },
    })
    .then((response) => {
      return response.data;
...
export const updateSubUser = async (data, id) => {
  const token = await AsyncStorage.getItem("4brntoken");
  return axios
    .put(config.api_url + "/api/v1/subuser/set/" + id, data, {
      headers: { "x-access-token": token },
    })
    .then((response) => {
      return response.data;
