...
export const getAllLevel = async (subuser_id, theme_id) => {
  ...
  return axios
    .get(config.api_url + "/api/v1/all/level/" + subuser_id + "/" + theme_id, {
...
export const saveNewLevel = async (data) => {
  const token = await AsyncStorage.getItem("4brntoken");
  return axios
    .post(config.api_url + "/api/v1/level/add", data, {
      headers: { "x-access-token": token },
    })
    .then((res) => {
      return res.data;
...
export const setLevel = async (subuser_id, data, theme_id) => {
  ...
  return axios
    .put(
      config.api_url + "/api/v1/level/set/" + subuser_id + "/" + theme_id,
      data,
      { headers: { "x-access-token": token } }
    )
    .then((response) => {
...
export const deleteLevel = async (level_id, theme_id) => {
  ...
  return axios
    .delete(
      config.api_url + "/api/v1/delete/level/" + level_id + "/" + theme_id,
      { headers: { "x-access-token": token } }
    )
    .then((response) => {
      return response.data;
